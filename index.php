...
$query1 = mysqli_query($connection, "SHOW TABLES LIKE 'ucapan'");

// Create Table if Does Not Exists
if (mysqli_num_rows($query1) == 0) {
    $table_ucapan = "CREATE TABLE `ucapan` (
    ...
    <div class="card">
        ...
        <section class="intro">
            <div class="content">
                ...
                <h2 class="fade-top-3">Haris</h2>
                <h2 class="fade-top-3">&</h2>
                <h2 class="fade-top-3">Dannea</h2>
        ...
        <section class="info">
            ...
            <div class="event-info reveal fade-bottom">
                <div class="one">
                    ...
                    <p>kami</p>
                    <div class="parent">
                        <p>Muhammad Isror Bin Abdul Hamid</p>
                        <p>&</p>
                        <p>Rohaya Binti Nordin</p>
                    </div>
                    <p>Menjemput</p>
                ...
                <div class="two">
                    <p>Haris Lukman Bin Muhammad Isror</p>
                    <p>&</p>
                    <p>Dannea Zulaikha Binti Dzulkarnain</p>
                </div>
                <div class="three">
                    <p class="title">Tempat</p>
                    <p>Dewan Cindai, Institut Kraf Negara</p>
                    <p>No 1, KM20 Jalan Ipoh-Rawang</p>
                    <p>Taman Rekreasi Templer</p>
            ...
            <div class="rsvp">
                ...
                <div class="container-message reveal fade-bottom">
                    <?php
                    $query = mysqli_query($connection, "SELECT * FROM ucapan");
            ...
            <div class="content">
                <div class="person">
                    ...
                    <div class="second-section">
                        <button onclick="makePhoneCall('+60197775931')"><i class='bx bx-phone'></i></button>
                        <button onclick="openWhatsApp('+60197775931')"><i class='bx bxl-whatsapp'></i></button>
                    </div>
                </div>
                <div class="person">
                    <div class="first-section">
                        <i class='bx bxs-user-circle'></i>
                        <div class="name">
                            <span>Nur Diyana</span>
                            <span>Kakak Pengantin Lelaki</span>
                        </div>
                    </div>
                    <div class="second-section">
                        <button onclick="makePhoneCall('+60193373790')"><i class='bx bx-phone'></i></button>
                        <button onclick="openWhatsApp('+60193373790')"><i class='bx bxl-whatsapp'></i></button>
                    </div>
                </div>
                <div class="person">
                    <div class="first-section">
                        <i class='bx bxs-user-circle'></i>
                        <div class="name">
                            <span>Umar Faris</span>
                            <span>Abang Pengantin Lelaki</span>
                        </div>
                    </div>
                    <div class="second-section">
                        <button onclick="makePhoneCall('+60192828724')"><i class='bx bx-phone'></i></button>
                        <button onclick="openWhatsApp('+60192828724')"><i class='bx bxl-whatsapp'></i></button>
                    </div>
                </div>
            </div>
        </div>
